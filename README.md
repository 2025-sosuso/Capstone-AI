...
### 핵심 가치
- 🎯 **정교한 감정 분석**: 단순 긍정/부정을 넘어 7가지 세부 감정(기쁨, 사랑, 감사, 화남, 슬픔, 두려움, 중립)으로 분류
- 📊 **시계열 여론 추적**: 날짜별 감정 변화를 시각화하여 논란 확산 시점을 실시간으로 탐지
- 🔍 **영상 비교 분석**: 최대 3개 영상의 반응을 동시에 비교하여 콘텐츠 전략 수립 지원
